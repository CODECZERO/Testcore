...
const Radio = () => {
  ...
  const handleLogout = () => {
    ...
    navigate("/sign-up"); // Adjust the redirect path if necessary
  };
    
  return (
    <StyledWrapper>
      <div className="input">
        <button className="value"    onClick={() => navigate("/Profileaccount")}>
