...
const verifyData = AsyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = ((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.accessToken) || (headertoken === null || headertoken === void 0 ? void 0 : headertoken.replace("Bearer ", "")); // Handling cookies and headers
        if (!token) {
...
const verifyexamData = AsyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try { //write user verify logic here
        const token = ((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.ExamToken) || req.body;
        const userTkone = (_b = req.cookies) === null || _b === void 0 ? void 0 : _b.accessToken;
        if (!token || !userTkone)
